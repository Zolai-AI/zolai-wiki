...
| Zolai | English | Note |
|---|---|---|
| Sepkhop kimawlna | Group play/activity | Context suggests group activity or game. |
| lung muanhui ahkl muanhuailo | whether it is pleasing or not pleasing | Implied contrast of feeling/suitability. |
| kihel hilna no laidal pitawh lahna bawl | making a demonstration/illustration with a handout | 'no laidal' likely means handout/worksheet. |
...
| Sinding thu | Learning topics/content |  |
| Gamtat hoih | Good behavior/conduct |  |
| Sehgawm sehken | Sharing/Cooperation |  |
| Gualtat tawh kisai sinphatnate | Lessons related to effort/diligence |  |
| Nuntak khuasakzia siamna | Life skills/Manners |  |
| Tuakkhial kidop ding | Helping each other when in difficulty |  |
| kammal thakte theihsakna | making new words known |  |
...
| vanlena bawlkhiat nadingin semkhawm | working together to create tools/materials |  |
| kiho kithuahna leh sepkhopna thapiak ding | to promote communication and cooperation |  |
| lawptak kihelna | active participation |  |
| kiho kizopna | communication/connection |  |
| kikholhsiam khansakna | promoting good interaction/social skills |  |
...
| kiho kizopna leh sepkhopna khansak nading ngiata kigeel sepzia zawipi tuamtuam | various major planned activities to promote interaction and cooperation |  |
| kimawl-bulphuh laisinna zawipite tawh gawmkhop ding haksa ding hiam | will it be difficult to combine with the main parts of play-based learning |  |
| pilsin vaiheelzia khat hi | it is one method of teaching |  |
| kimawl pen laisinna vai-maban sunga kihelpih a mungpi khatin guang hi | play is considered a main component that is integrated into the learning process |  |
| kankhiatna tawh muibunpen ahihlam | that it is the best way through understanding |  |
| phawk gige hi | it always reminds/highlights |  |
| hilhtelziate pen laihilh vaiheelziate hi | the models/examples are teaching methods |  |
| kimawlna thupisakin laihilh leh laisin vai-maban sungah kimawlna zong guang hi | play is emphasized and included in the teaching and learning process |  |
| thu theih theihna | ability to understand things |  |
| gualtatna | diligence/effort |  |
| lungphawnna | expression of feeling |  |
| cilesa pumpi | overall physical development |  |
| khantoh nading vai ah kimawlna a thupitzia phawkkha ahih manin | because it highlights the importance of play in the aspect of promoting development |  |
| bulpi gentehnate ah | in its main examples |  |
| mellema dingpite in | the benefits/advantages |  |
| lawmlegual tawh kikholhna | interaction with friends |  |
| Gual kikholhna leh sepkhopna lapsan nading sepzia zawipi pawlkhat | Some major procedures for continuing competition and cooperation |  |
| Vai sehcian-bulphuh laisinna | Task division-main learning |  |
| Khangualpih kipattah kimakaih | Establishing peer relationships |  |
| Pankhop laisin kilamziate | Number learning aspects |  |
| A hoihlam a thapia thadipna | Positive reinforcement |  |
| vaibuaite phelsiang nading | for solving problems |  |
| vanlena bawlkhiat nadingin semkhawm | working together to create tools/materials |  |
| kiho kithuahna leh sepkhopna thapiak ding | to promote communication and cooperation |  |
...
| Word | Parts | Meaning |
|---|---|---|
| Sepkhop | Sep+khop | Group work/activity |
| lungmuanhui | lung+muan+hui | pleasing/satisfying (lung=heart, muan=pleasing, hui=suffix?) |
| genkhia | gen+khia | speak out/express |
| limsuaih | lim+suaih | illustration/diagram |
| pianzia | pian+zia | nature/character |
| genkhiatna | gen+khiat+na | expression |
| pawlkhop | pawl+khop | group |
| nasep | nasep | work/task |
| kopkhatta | kop+khatta | together/as one set |
| nasimna | na+sim+na | exercise/practice |
| puanakkilhnate | puanak+kilhna+te | instructions/guidance |
| kigawm | ki+gawm | combined/added together |
| pawlpihte | pawl+pih+te | their group/team |
| phedal | phe+dal | card/slip (used in game) |
| gawmkhawm | gawm+khawm | add together/gather |
| kemkha | kem+kha | keep/retain |
| Sehgawm | seh+gawm | sharing/cooperation |
| Gualtat | Gual+tat | Diligence/Effort |
| Tuakkhial | Tuak+khial | in difficulty/trouble |
| kidop | ki+dop | helping each other |
| kammal | kam+mal | word |
| kidemnate | ki+dem+nate | competition |
| kihonate | ki+ho+nate | conversation |
| khangsak | khang+sak | promote/develop |
| thapiakna | tha+piak+na | encouragement/support |
| lunglawnnate | lung+lawnna+te | interests |
| khangualpihte | khangual+pih+te | elders/seniors |
| lungphawnnalam | lungphawnna+lam | aspect of expression |
| thubuai | thubuai | problem/issue |
| phelsiangna | phel+siang+na | solving/settling |
| kipawlkhop | ki+pawl+khop | cooperate/work together |
| kikupkhop | ki+kup+khop | work together |
| sungkhawmin | sung+khawm+in | sharing (difficulties) |
| thahatsak | tha+hat+sak | strengthen/reinforce |
| kihotuahna | ki+hotuah+na | coordination |
| zawhsiang | zawh+siang | complete/finish |
| vaibuaite | vai+buai+te | problems/issues |
| vanlena | van+lena | tool/material |
| bawlkhiat | bawl+khiat | create/make |
| kiho | ki+ho | communicate/talk |
| kithuahna | ki+thuah+na | helping each other |
| sepkhopna | sep+khop+na | cooperation |
| kihelna | ki+hel+na | participation |
| kikholhsiam | ki+kholh+siam | good interaction/socializing |
| kihopsawnna | ki+hopsawn+na | sharing/exchanging |
| kiimlepam | kiim+lepam | attitude/disposition |
| kimawl-bulphuh | kimawl+bulphuh | play-based |
| laisinna | laisin+na | learning/study |
| vaiheelzia | vaiheel+zia | method/approach |
| kihelpih | ki+hel+pih | integrated/included |
| mungpi | mung+pi | main component |
| lawptak | lawp+tak | active/successful |
| kikholhna | ki+kholh+na | interaction/socializing |
| lapsan nading | lap+san+nading | for continuing |
| Pankhop | Pan+khop | Number group |
| kilamziate | kilam+zia+te | aspects/features |
| thadipna | tha+dip+na | reinforcement |
| nehtheina | neh+thei+na | reviewing/checking |
| thuah leh | thuah+leh | if you want to know more |
| kihelin | ki+hel+in | self-discovery/realization |
| zangkhia thei-in | zang+khia+thei+in | being able to apply |
| neh tohtoh kawmin | neh+tohtoh+kawm+in | gradually reaching/achieving |
...
- `syanu/pa in nasimna/puanakkilhnate kopkhatta pia leh tua khitteh sepding hilna nei` = When the mother/father gives the exercise/instruction together, those things have instructions on what to do.
  - e.g. `syanu/pa in nasimna/puanakkilhnate kopkhatta pia leh tua khitteh sepding hilna nei`
- `syanu/pa in nambat [number] dal a lah ciang, sangnaupangte in tua nasimna [number] khiasuk.` = When the mother/father points out number [number], the students complete that exercise [number].
  - e.g. `syanu/pa in nambat 4 dal a lah ciang, sangnaupangte in tua nasimna 4 khiasuk.`
- `A kimawl khatta in phe dal [number] ta kai, tua dalnihte nambatte gawmkhawm leh a kigawm bangzah ngah cih amau pawlpihte kiang gen.` = One player takes [number] cards/slips, adds the numbers on those slips, and tells their group how much they got when combined.
...
- `Sangnaupangte kikal ah kiho kithuahna leh sepkhopna thapiak ding pen a muibun laihilhna sunga kihelpih a mungpi khat hi a, tua in lawptak kihelna, kiho kizopna, kikholhsiam khansakna, etzia muhcia kibanglote kihopsawnna, cihte khangsak banah laisin nading a cihoih kiimlepam hong pian nading zong huh hi.` = Promoting communication and cooperation among students is a main component integrated into effective teaching, and it promotes active participation, communication, developing good interaction, sharing different perspectives, and also helps in developing a good learning attitude for study.
  - e.g. `Sangnaupangte kikal ah kiho kithuahna leh sepkhopna thapiak ding pen a muibun laihilhna sunga kihelpih a mungpi khat hi a, tua in lawptak kihelna, kiho kizopna, kikholhsiam khansakna, etzia muhcia kibanglote kihopsawnna, cihte khangsak banah laisin nading a cihoih kiimlepam hong pian nading zong huh hi.`
- `Kimawl-bulphuh laisinna in mahlemah teeltawm, a lungnop-huai leh vai-maban a mitsuan ahi hi.` = Play-based learning is self-directed, enjoyable, and a guide for the future.
