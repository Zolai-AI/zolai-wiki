...
## 1. Particles & Function Words (Most Frequent)
...
| 7 | `leh` | and, with, return | 15,127 |
| 8 | `ka` | I (agreement marker, 1st sg) | 13,359 |
| 9 | `tua` | that, those (demonstrative) | 12,249 |
| 10 | `ciangin` | then, at that time | 9,999 |
| 11 | `tawh` | key, free-hand | 7,811 |
| 12 | `kei` | I (pronoun, subject) | 6,881 |
| 13 | `dingin` | will (future+reason) | 6,425 |
| 14 | `ahih` | but, however (contrastive) | 6,165 |
| 15 | `pen` | topic/focus marker | 4,721 |
| 16 | `hiam` | ? (question particle) | 4,244 |
| 17 | `bangin` | as like as, whereas | 4,063 |
| 18 | `bang` | what | 4,012 |
| 19 | `un` | ! (plural imperative) | 3,550 |
| 20 | `zong` | also, even | 3,499 |
| 21 | `hangin` | because, since (reason) | 3,556 |
| 22 | `manin` | because, since (reason) | 3,104 |
| 23 | `takin` | truly, indeed, verily | 666 |
| 24 | `ci-in` | that | 1,934 |
| 25 | `la` | La, dirge | 2,767 |

---

## 2. Nouns (High Frequency)

| Rank | Word | Translation | Frequency |
| :--- | :--- | :--- | :--- |
| 1 | `topa` | Lord, Master | 7,433 |
| 2 | `mite` | people, persons | 7,043 |
| 3 | `pasian` | God | 5,549 |
| 4 | `mi` | person / man | 4,968 |
| 5 | `ama` | mother, woman, wife | 4,141 |
| 6 | `tapa` | son | 2,134 |
| 7 | `thu` | word, matter, thing | 5,825 |
| 8 | `ni` | day, sun | 1,475 |
...
| 15 | `lungsim` | thought | 986 |
| 16 | `min` | name | 969 |
| 17 | `an` | food / rice | 929 |
| 18 | `kum` | year | 926 |
| 19 | `khua` | village, place | 897 |
| 20 | `kha` | die, death | 889 |
| 21 | `mun` | place | 865 |
| 22 | `lam` | way, path, road | 863 |
| 23 | `mawhna` | sin, trespass | 731 |
| 24 | `vantung` | Heaven, Sky | 730 |
| 25 | `piak` | offering, sacrifice | 725 |
| 26 | `inn` | house, home | 699 |
| 27 | `biakinn` | house (worship-house) | 789 |
| 28 | `suang` | Stone / Rock | 288 |
| 29 | `lampi` | Road | 287 |
| 30 | `laibu` | book | 173 |

---

## 3. Verbs (High Frequency)
...
| 8 | `nei` | have, possess | 1,397 |
| 9 | `za` | hear | 1,031 |
| 10 | `mu` | see, look | 909 |
| 11 | `ngah` | get | 700 |
| 12 | `sem` | work | 569 |
| 13 | `sawl` | to tell someone to do something | 500 |
| 14 | `gen` | speak, say, tell | 2,325 |
| 15 | `dong` | ask | 505 |
| 16 | `ne` | eat, consume | 486 |
...
| :--- | :--- | :--- |
| `ka` | I (1st singular) | 13,359 |
| `kei` | I (1st singular, emphatic) | 6,881 |
| `amah` | he/she/it (3rd singular) | 6,269 |
| `amaute` | they (3rd plural, emphatic) | 6,188 |
| `amau` | their (3rd plural possessive) | 1,707 |
| `nang` | you (2nd singular) | 1,928 |
| `nangmah` | you, thou (emphatic) | 653 |
| `eite` | we (inclusive plural) | 723 |
| `kote` | they (3rd plural, dialectal) | 775 |
| `hita` | they (3rd plural) | 486 |
| `keimah` | I am (emphatic identity) | 864 |
| `ko` | we (1st pl exclusive) | 220 |
...
| Word | Translation | Frequency |
| :--- | :--- | :--- |
| `hoih` | good, beautiful | 504 |
| `lian` | big, great | 360 |
| `tampi` | much | 733 |
| `hoihzaw` | well (comparative) | 117 |
| `tawntung` | forever, eternally | 658 |
| `takpi` | certain | 167 |
| `siampi` | faithful, religiously devoted | 419 |
| `vanglian` | powerful | 317 |
| `thuman` | truth, righteous | 454 |
| `khuamial` | dark | 146 |
| `khuavak` | light | 195 |
...
| `ni` | day, sun | 1,475 |
| `kum` | year | 926 |
| `tu-in` | now, at this point | 962 |
| `zingsang` | yesterday morning | 153 |
| `ciangdong` | day | 195 |
| `nitak` | evening | 136 |
| `tuni` | day | 117 |
...
| Word | Translation | Frequency |
| :--- | :--- | :--- |
| `vantung` | Heaven, Sky | 730 |
| `leitung` | Earth, World | 808 |
| `gam` | earth, land | 1,943 |
| `tui` | water | 670 |
| `mual` | Mountain, hill | 421 |
| `gun` | river | 170 |
| `tuipi` | Sea / Ocean | 364 |
| `gamlak` | Forest / Jungle | 126 |
| `guah` | Rain | 95 |
| `huih` | Wind | 100 |
| `mei` | fire | 350 |
| `khuavak` | light | 195 |
...
| :--- | :--- | :--- |
| `pa` | Father | 1,345 |
| `ama` | mother, woman, wife | 4,141 |
| `tapa` | son | 2,134 |
| `tanu` | Daughter | 282 |
| `pasal` | man, husband | 418 |
| `numei` | woman, female person | 736 |
| `mipa` | man, person | 739 |
| `sanggam` | Sibling | 114 |
| `innkuan` | family, household | 203 |
| `suante` | children | 329 |
| `tate` | children | 363 |
