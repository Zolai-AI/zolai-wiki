# Phrases & Patterns from: course15_play_based_learning_zolai.md:0-500
...
| vai-maban bulphuh | important aspect of the process/procedure | Bulphuh means important/main aspect. |
| khinkhai ngaihsut siamna | critical thinking skills | Literally 'skill of thinking deeply/carefully'. |
...
| a noptuak hang, pawlkhat noptuak lo ahihlam | that some feelings are enjoyable, while others are not | Noptuak = enjoyable/pleasing. |

## Compound Words

| Word | Parts | Meaning |
|---|---|---|
| Kimawl-bulphuh | Kimawl + bulphuh | Play-based (Play + main/important) |
| Hilhtelziate | Hilh + tel + zia + te | Teaching approaches/methods (Teach + specify/detail + manner + plural) |
| Laisinna | Lai + sinna | Learning process (Book/lesson + process of knowing) |
| Thusinna | Thu + sinna | Instruction/Teaching (Word/matter + process of knowing) |
| Ngahkhiat | Ngah + khiat | Achievement/Outcome (Get + out) |
| Kiho kizopzia | Kiho + kizopzia | Communication (Talking to each other + manner of connecting) |
| Sepkhopzia | Sep + khopzia | Collaboration (Working + manner of joining/together) |
| Mellema dingpite | Mellema + dingpite | Benefits/Advantages (Good results/benefits + things/aspects) |
| Lungngaihna | Lung + ngaihna | Reflection/Consideration (Heart/mind + contemplation) |
| Theihhuai Thute | Theih + huai + thute | Important information (Know + worthy + matters) |
| Limmuh tongngaih | Limmuh + tongngaih | Videos (Visual image + watch) |
| Kihelna | Kihel + na | Participation/Engagement (Involve oneself + nominalizer) |
| Thutheihnopna | Thu + theih + nopna | Curiosity (Matter + knowing + desire) |
| Taksinnate | Tak + sinna + te | Practical activities (Doing/action + process + plural) |
| Thupaipite | Thu + paipi + te | Guidelines/Principles (Matter + main/important + plural) |
| Pilsinna | Pil + sinna | Development/Growth (Wise/skilled + process) |
| Khuakzatnalam | Khuak + zatna + lam | Cognitive aspect (Brain + usage + side) |
| Gualtatnalam | Gualtat + na + lam | Affective aspect (Enjoyment/satisfaction + nominalizer + side) |
| Lungphawnnalam | Lung + phawnna + lam | Social/Emotional aspect (Heart/mind + expression + side) |
| Pumpi taksalam | Pumpi + taksa + lam | Physical aspect (Whole body + body + side) |
| Laisin gamtat sepkhiatte | Laisin + gamtat + sepkhiat + te | Learning practical activities (Learning + action + completed work + plural) |
| Limlemel ciamteh | Limlemel + ciamteh | Identify examples (Example/model + recognize/identify) |
| Kikhelna | Kihel + na | Interaction/Exchange (Involve oneself + nominalizer) |
| Vaibuai phelzia | Vaibuai + phelzia | Problem-solving method (Difficulty/problem + manner of solving) |
| Khenkhiakik | Khen + khiak + kik | Re-sort/Re-classify (Separate + take out + reciprocal) |

## Sentence Patterns

- `X pen Y ahi hi.` = X is Y.
  - e.g. `Kimawl-bulphuh laisinna pen Tan Lang (...) sangnaupang leh phungpi (...) sangnaupang tan a tawmlamte’ adingin a muibun mahmah laihilh zialedan khat ahi hi.`
...
- `Hih module zawh ciangin na hihtheih dingte: X, Y, Z.` = Upon finishing this module, what you will be able to do are: X, Y, Z.
  - e.g. `Hih module zawh ciangin na hihtheih dingte: - Kimawl-bulphuh hilhtelzia bulpi gentehnate zongkhia - Kimawl-bulphuh laisinna ii mellema dingpite kankhia - Laihilh leh laisin gamtat sepkhiatte khentel, kimawl-bulphuh laisinna ii limlemel ciamteh`
- `X cih ciangin Y pen Z khat bangin kisang hi.` = When we say X, Y is regarded as Z.
  - e.g. `Kimawl-bulphuh laihilhna leh laisinna vai ah, kimawl cih pen naupangte thu a kankhiasak, thu a mukhiasak, leh amau' kimlepam a theikhiasak, ngimna nei leh khiatna nei gamtat sepkhiat khatin kisang hi.`
