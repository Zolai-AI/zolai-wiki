...
| ** corpus** | 686MB | 3M+ sentences | Various | Conversational | Modern spoken Zolai |
| **Reference materials** | 6.5MB | 23 files | 1899–2013 | Academic/Grammar | Authoritative grammar rules |
| ** dictionary** | 6.7MB | 7,841 headwords | Various | Trilingual | ZO-EN-MY |
...
| ** corpus** | Large (3M+ sentences), conversational, modern | No parallel, informal | Spoken patterns, colloquialisms |
| **Reference materials** | Authoritative grammar, historical depth | Limited vocabulary, academic | Grammar rules, historical forms |
| ** dictionary** | Trilingual (ZO-EN-MY), compact | Limited entries (7.8K) | Cross-language comparison |
...
| **** | ~30,000 | conversational, colloquial | Spoken vocabulary |
...
| Pattern | Bible | Zomidaily | Dictionary |  | Reference | Notes |
|---------|-------|-----------|------------|---------|-----------|-------|
...
| Pattern | Bible Example | Zomidaily Example |  Example | Notes |
|---------|---------------|-------------------|-----------------|-------|
...
| Register | Bible | Zomidaily | Dictionary |  | Reference | Notes |
|----------|-------|-----------|------------|---------|-----------|-------|
...
| **Conversational** | ❌ Low | ✅ High | ❌ Low | ✅ High | ❌ Low | Zomidaily/-dominated |
| **Poetic** | ✅ High | ❌ Low | ❌ Low | ❌ Low | ⚠️ Low | Bible-dominated |

### 4.2. Register Examples

| Register | Bible Example | Zomidaily Example |  Example | Notes |
|----------|---------------|-------------------|-----------------|-------|
...
| Period | Bible | Zomidaily | Dictionary |  | Reference | Notes |
|--------|-------|-----------|------------|---------|-----------|-------|
...
| **2010–2026** | ❌ Low | ✅ High | ⚠️ Low | ✅ High | ❌ Low | Zomidaily/-dominated |
...
| **Modern-only** | Loan words not in Bible | Zomidaily,  | `komputa`, `sikuul` | Not in Bible |
| **Dictionary-only** | Archaic forms in dictionary | Dictionary | `pathian`, `ram` | Forbidden in ZVS 2018 |
| **-only** | Colloquialisms |  | `mahmah`, `ahihi` | Informal only |
...
| **Modern-only** | Informal patterns | Zomidaily,  | `lo` negation | Modern resurgence |
| **Dictionary-only** | Archaic patterns | Dictionary | `cu/cun` conjunction | Forbidden in ZVS 2018 |
| **-only** | Colloquial patterns |  | discourse markers | Informal only |
...
| **-only** | Conversational register |  | colloquialisms | Not in formal writing |
...
| Validation | Bible | Zomidaily | Dictionary |  | Notes |
|------------|-------|-----------|------------|---------|-------|
...
| **Zomidaily + ** | Modern + spoken | Contemporary use | Modern Zolai |
| **Bible + Zomidaily** | Formal + modern | Register comparison | Historical shift |
| **Dictionary + ** | Vocabulary + context | Word usage | Real-world examples |
...
| **Add register** |  | Dictionary | Usage tags | Register information |
| **Add etymology** | Reference | Dictionary | Historical forms | Etymology data |
| **Add cognates** |  | Dictionary | Cross-language | Cognate data |
...
| **Use  for spoken patterns** | Medium | Conversational Zolai | Spoken language |
...
| ** for spoken patterns** | Medium | Conversational data | Spoken language |
...
4.  corpus (3M+ sentences)
5. Reference materials (23 files)
6.  dictionary (7,841 headwords)
